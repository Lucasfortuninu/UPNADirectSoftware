...
public class VistaConsola implements IVistaCorreduria{
    ...
    public String consultarTipoBien() {
        System.out.print(ANSI_PURPLE + "//TipoBien> " + ANSI_RESET);
        String tipoBien = scanner.nextLine();
        return tipoBien;
    }
    @Override
    public int consultarValorBien() {
        System.out.print(ANSI_PURPLE + "//ValorBien> " + ANSI_RESET);
